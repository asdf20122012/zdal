...
public class SR956010 {
	...
	public void TC956011() {
		...
		params.put("clum", 100);
		try {
			rs = (List<Object>) sqlMap.queryForList("zdalsqlParserMysql01Sql",
					params);
		} catch (Exception ex) {
			ex.printStackTrace();
		}
	...
	public void TC956012() {
		...
		try {
			rs = (List<Object>) sqlMap.queryForList("zdalsqlParserMysql02Sql",
					params);
		} catch (Exception ex) {
			ex.printStackTrace();
		}
		Assert.areEqual(2, rs.size(), "select colu2 from test1 where test1.clum in (#clum1#,#clum2#) 的断言");
	}
	...
	public void TC956013(){
		...
		params.put("clum2", 200);
		try {
			rs = (List<Object>) sqlMap.queryForList("zdalsqlParserMysql03Sql",
					params);
		} catch (Exception ex) {
			ex.printStackTrace();
		}
	...
	public void TC956014(){
		...
		params.put("clum1", 100);
		try {
			rs = (List<Object>) sqlMap.queryForList("zdalsqlParserMysql04Sql",
					params);
		} catch (Exception ex) {
			ex.printStackTrace();
		}
	...
	public void TC956015(){
		...
		params.put("clum1", 100);
		try {
			rs = (List<Object>) sqlMap.queryForList("zdalsqlParserMysql05Sql",
					params);
		} catch (Exception ex) {
			ex.printStackTrace();
		}
		Assert.areEqual(1, rs.size(), "select colu2 from test1 where test1.clum not in (#clum1#)的断言");
	}
	...
	public void TC956016(){
		...
		params.put("clum1", 100);
		try {
			rs = (List<Object>) sqlMap.queryForList("zdalsqlParserMysql06Sql",
					params);
		} catch (Exception ex) {
			ex.printStackTrace();
		}
		HashMap hs=(HashMap)rs.get(0);
		Assert.areEqual("1", hs.get("count").toString(), "select count(*) from test1 where test1.clum = #clum1#的断言");
	...
	public void TC956017(){
		...
		params.put("clum1", 100);
		try {
			rs = (List<Object>) sqlMap.queryForList("zdalsqlParserMysql07Sql",
					params);
		} catch (Exception ex) {
			ex.printStackTrace();
		}
		HashMap hs=(HashMap)rs.get(0);		
		Assert.areEqual("1", hs.get("count").toString(), "select count(1) from test1 where test1.clum = #clum1#的断言");
	...
	public void TC956018(){
		...
		params.put("clum1", 100);
		try {
			rs = (List<Object>) sqlMap.queryForList("zdalsqlParserMysql08Sql",
					params);
		} catch (Exception ex) {
			ex.printStackTrace();
		}
		HashMap hs=(HashMap)rs.get(0);		
		Assert.areEqual("1", hs.get("count").toString(), "select count(1) as count from test1 where (test1.colu2 is not null) and test1.clum = #clum1#");
	...
	public void TC956019(){
		...
		params.put("clum1", 100);
		try {
			rs = (List<Object>) sqlMap.queryForList("zdalsqlParserMysql09Sql",
					params);
		} catch (Exception ex) {
			ex.printStackTrace();
		}
		HashMap hs=(HashMap)rs.get(0);		
		Assert.areEqual("1", hs.get("count").toString(), "select count(1) as count from test1 where (test1.colu2 in('DB_A','DB_B')) and test1.clum = #clum1#");
	}
	...
	public void TC95601a(){
		...
		params.put("clum1", 100);
		try {
			rs = (List<Object>) sqlMap.queryForList("zdalsqlParserMysql10Sql",
					params);
		} catch (Exception ex) {
			ex.printStackTrace();
		}
		HashMap hs=(HashMap)rs.get(0);		
		Assert.areEqual("1", hs.get("count").toString(), "select count(1) as count from test1 where (test1.colu2 in('DB_A','DB_B')) and test1.clum = #clum1# order by test1.clum");
	}
	...
	public void TC95601b(){
		...
		params.put("clum1", 100);
		try {
			rs = (List<Object>) sqlMap.queryForList("zdalsqlParserMysql11Sql",
					params);
		} catch (Exception ex) {
			ex.printStackTrace();
		}
		HashMap hs=(HashMap)rs.get(0);		
		Assert.areEqual("1", hs.get("count").toString(), "select count(1) as count from test1 where (test1.colu2 not in('DB_D','DB_E')) and test1.clum = #clum1# ");
	}
	...
	public void TC95601c(){
		...
		params.put("clum1", 100);
		try {
			rs = (List<Object>) sqlMap.queryForList("zdalsqlParserMysql12Sql",
					params);
		} catch (Exception ex) {
			ex.printStackTrace();
		}
		HashMap hs=(HashMap)rs.get(0);		
		Assert.areEqual("DB_A", hs.get("colu2").toString(), "select distinct(colu2) as colu2 from test1 where (test1.colu2 not in('DB_D','DB_E')) and test1.clum = #clum1# ");
	}
	...
	public void TC95601d(){
		...
		params.put("clum1", 100);
		try {
			rs = (List<Object>) sqlMap.queryForList("zdalsqlParserMysql13Sql",
					params);
		} catch (Exception ex) {
			ex.printStackTrace();
		}
		HashMap hs=(HashMap)rs.get(0);		
		Assert.areEqual("2", hs.get("count").toString(), "select count(*) as count from test1 where (test1.colu2 not in('DB_D','DB_E')) and test1.colu2 like '%DB%' ");
	}
	...
	public void TC95601g(){		
		...
		HashMap hs=(HashMap)rs.get(0);		
		Assert.areEqual("1", hs.get("count").toString(), "select count(*) as count from test1 where test1.clum > 101 ");
	}
	...
	public void TC95601j(){	
		...
		HashMap hs=(HashMap)rs.get(0);
		Assert.areEqual("300", hs.get("sumvalue").toString(), "select sum(clum) as sumvalue from test1 where test1.clum <= 201");	
	}
	...
	public void TC95601k(){	
		...
		HashMap hs=(HashMap)rs.get(0);
		Assert.areEqual("100", hs.get("minvalue").toString(), "select min(clum) as minvalue from test1 where test1.clum <= 201");	
	...
	public void TC95601l(){	
		...
		HashMap hs=(HashMap)rs.get(0);
		Assert.areEqual("200", hs.get("maxvalue").toString(), "select max(clum) as maxvalue from test1 where test1.clum <= 201");	
