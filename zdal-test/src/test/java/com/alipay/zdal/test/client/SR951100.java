...
public class SR951100 extends ZdalTestBase {
	...
	public void TC951102() {
		try {
			...
			zdalDataSource.initV3();
			zdalDataSource.getZdalConfigListener().resetWeight(hm);
			Map<String, ?> hs = zdalDataSource.getRwDataSourcePoolConfig();
	...
	public void TC951103() {
		...
		Assert.areEqual(ConstantsTest.zone, zdalDataSource.getZone(),
				"init zdalDataSource,then getzone");
	...
	public void TC951105() {
		...
		while (it.hasNext()) {
			...
			int ps_ds = zDataSource.getLocalTxDataSource()
					.getPreparedStatementCacheSize();
			int query_ds = zDataSource.getLocalTxDataSource().getQueryTimeout();
			int block_ds = zDataSource.getLocalTxDataSource()
					.getBlockingTimeoutMillis();
			long ide_ds = zDataSource.getLocalTxDataSource()
