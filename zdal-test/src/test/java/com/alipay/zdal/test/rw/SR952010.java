...
public class SR952010 {
	...
	public void TC952011() {
		...
		HashMap<String, Integer> mp = writeRwMysqlDB("zdalRwMysql1",
				"insertRwSql");
	...
	public void TC952013() {
		...
		HashMap<String, Integer> mp = writeRwMysqlDB("zdalRwMysql2",
				"insertRwSql");
		int count1 = mp.get("count1");
		int count2 = mp.get("count2");
		Step("断言数据取值个数");
	...
	public void TC952014() {
		...
		ZdalTestCommon.dataPrepareForZds();
		HashMap<String, Integer> mp = readRwMysqlDB("zdalRwMysql2",
				"queryRwSql");
		int countA = mp.get("countA");
		int countB = mp.get("countB");
		Step("断言取值个数");
	...
	public void TC952015() {
		...
		HashMap<String, Integer> mp = writeRwMysqlDB("zdalRwMysql3",
				"insertRwSql");
		int count1 = mp.get("count1");
		int count2 = mp.get("count2");
		Step("断言取值个数");
	...
	public void TC952016() {
		...
		ZdalTestCommon.dataPrepareForZds();
		HashMap<String, Integer> mp = readRwMysqlDB("zdalRwMysql3",
				"queryRwSql");
		int countA = mp.get("countA");
		int countB = mp.get("countB");
		Step("断言取值个数");
	...
	public void TC952017() {
		...
		HashMap<String, Integer> mp = writeRwMysqlDB("zdalRwMysql4",
				"insertRwSql");
		int count1 = mp.get("count1");
		int count2 = mp.get("count2");
		Step("断言取值个数");
	...
	public void TC952018() {
		...
		ZdalTestCommon.dataPrepareForZds();
		HashMap<String, Integer> mp = readRwMysqlDB("zdalRwMysql4",
				"queryRwSql");
		int countA = mp.get("countA");
		int countB = mp.get("countB");
		Step("断言获取数据个数");
	...
	public void TC952019() {
		...
		HashMap<String, Integer> mp = writeRwMysqlDB("zdalRwMysql5",
				"insertRwSql");
		int count1 = mp.get("count1");
		int count2 = mp.get("count2");
		Step("获取数据个数");
	...
	public void TC95201a() {
		...
		ZdalTestCommon.dataPrepareForZds();
		HashMap<String, Integer> mp = readRwMysqlDB("zdalRwMysql5",
				"queryRwSql");
		int countA = mp.get("countA");
		int countB = mp.get("countB");
		Step("获取数据个数");
	...
	public void TC95201b() {
		...
		HashMap<String, Integer> mp = writeRwMysqlDB("zdalRwMysql6",
				"insertRwSql");
		int count1 = mp.get("count1");
		int count2 = mp.get("count2");
		Step("获取数据个数");
	...
	public void TC95201c() {
		...
		ZdalTestCommon.dataPrepareForZds();
		HashMap<String, Integer> mp = readRwMysqlDB("zdalRwMysql6",
				"queryRwSql");
		int countA = mp.get("countA");
		int countB = mp.get("countB");
		Step("获取数据个数");
	...
	public void TC95201d() {
		Step("rw 写库:ds0:r1w1");
		HashMap<String, Integer> mp = writeRwMysqlDB("zdalRwMysql7",
				"insertRwSql");
		int count1 = mp.get("count1");
		int count2 = mp.get("count2");
		Step("获取数据个数");
	...
	public void TC95201e() {
		ZdalTestCommon.dataPrepareForZds();
		HashMap<String, Integer> mp = readRwMysqlDB("zdalRwMysql7",
				"queryRwSql");
		int countA = mp.get("countA");
		int countB = mp.get("countB");
		Assert.areEqual(true, countA == 30, "the countA value");
	...
	public void TC95201f() {
		...
		HashMap<String, Integer> mp = writeRwMysqlDB("zdalRwMysql8",
				"insertRwSql");
		int count1 = mp.get("count1");
		int count2 = mp.get("count2");
		Step("获取数据个数");
	...
	public void TC95201h() {
		...
		ZdalTestCommon.dataPrepareForZds();
		HashMap<String, Integer> mp = readRwMysqlDB("zdalRwMysql8",
				"queryRwSql");
		int countA = mp.get("countA");
		int countB = mp.get("countB");
	...
	public void TC95201i() {
		...
		HashMap<String, Integer> mp = writeRwMysqlDB("zdalRwMysql9",
				"insertRwSql");
		int count1 = mp.get("count1");
		int count2 = mp.get("count2");
		Assert.areEqual(true, count1 == 0, "the count1 value");
	...
	public void TC95201j() {
		...
		ZdalTestCommon.dataPrepareForZds();
		HashMap<String, Integer> mp = readRwMysqlDB("zdalRwMysql9",
				"queryRwSql");
		int countA = mp.get("countA");
		int countB = mp.get("countB");
		Step("获取数据个数");
