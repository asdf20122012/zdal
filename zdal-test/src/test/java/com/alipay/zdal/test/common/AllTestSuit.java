...
import com.alipay.zdal.test.ut.client.UtZdalClientSuite;
import com.alipay.zdal.test.client.ZdalClientSuite;
import com.alipay.zdal.test.dynamicAdjustment.ZdalDynamicAdjustmentSuite;
import com.alipay.zdal.test.rw.ZdalRwSuite;
import com.alipay.zdal.test.sequence.ZdalSequenceSuite;
...
import com.alipay.zdal.test.ut.datasource.UtZdalDatasourceSuite;
...
@RunWith(Suite.class)
@Suite.SuiteClasses({ 
	ZdalClientSuite.class,ZdalRwSuite.class,
	ZdalSequenceSuite.class,ZdalShardfailoverSuite.class,
	ZdalShardrwSuite.class,ZdalSqlParserSuite.class,
	ZdalDynamicAdjustmentSuite.class,
	
	//ut
	UtZdalSqlParserMysqlSuite.class,UtZdalSqlParserOracleSuite.class,
	UtZdalDatasourceSuite.class,UtZdalClientSuite.class
