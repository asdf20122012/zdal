...
@ContextConfiguration(locations ={
		"/scalable/zdal-mysql-pool-10-context.xml"
})
public class ScalaDownMySQLConnectionInOutOfConnectionTests extends AbstractJUnit4SpringContextTests  {

	private static final Logger             logger               = Logger.getLogger(ScalaDownMySQLConnectionInOutOfConnectionTests.class);
	...
	private void validateConnectionStatis() {
		PoolCondition condition = dataSource.getLocalTxDataSource().getPoolCondition();
		System.out.println(ConnectionMonitor2.MIN_SIZE+ " : " +condition.getMinSize());
		System.out.println(ConnectionMonitor2.MAX_SIZE+ " : " +condition.getMaxSize());
		System.out.println(ConnectionMonitor2.STAT_TIME+ " : " +new Date());
		System.out.println(ConnectionMonitor2.ACC+ " : " +condition.getAvailableConnectionCount());
		System.out.println(ConnectionMonitor2.CC+ " : " +condition.getConnectionCount());
		System.out.println(ConnectionMonitor2.CCC+ " : " +condition.getConnectionCreatedCount());
		
		System.out.println(ConnectionMonitor2.CDC+ " : " +condition.getConnectionDestroyedCount());
		System.out.println(ConnectionMonitor2.IUCC+ " : " +condition.getInUseConnectionCount());
		System.out.println(ConnectionMonitor2.MCIUC+ " : " +condition.getMaxConnectionsInUseCount());
	}
	 ...
	 */
	@Test
	public void testScaleDownConnectionPoolSizeWithOutOfConnection() throws SQLException{
...
//				logger.debug("Thread " + excepEntry.getKey() + " Exception numbers " + excepEntry.getValue().size());
				...
				for( Exception exception : excepEntry.getValue() ){
