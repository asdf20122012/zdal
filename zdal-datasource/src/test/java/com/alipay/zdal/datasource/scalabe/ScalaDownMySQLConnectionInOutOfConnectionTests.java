...
public class ScalaDownMySQLConnectionInOutOfConnectionTests extends AbstractJUnit4SpringContextTests  {
	...
	private void validateConnectionStatis() {
		...
		System.out.println(ConnectionMonitor.MIN_SIZE+ " : " +condition.getMinSize());
		System.out.println(ConnectionMonitor.MAX_SIZE+ " : " +condition.getMaxSize());
		System.out.println(ConnectionMonitor.STAT_TIME+ " : " +new Date());
		System.out.println(ConnectionMonitor.ACC+ " : " +condition.getAvailableConnectionCount());
		System.out.println(ConnectionMonitor.CC+ " : " +condition.getConnectionCount());
		System.out.println(ConnectionMonitor.CCC+ " : " +condition.getConnectionCreatedCount());
		
		System.out.println(ConnectionMonitor.CDC+ " : " +condition.getConnectionDestroyedCount());
		System.out.println(ConnectionMonitor.IUCC+ " : " +condition.getInUseConnectionCount());
		System.out.println(ConnectionMonitor.MCIUC+ " : " +condition.getMaxConnectionsInUseCount());
	}
