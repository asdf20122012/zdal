...
public class ZDSTest{
	...
	protected String [] jndiName = {"DataSource-Oracle","DataSource-Mysql","DataSource-MysqlChange","DataSource-MysqlAPP"};
	
	 //TODO assert的处理
    public TestAssertion Assert = new TestAssertion();
    
    public final static Log Logger = LogFactory.getLog(ZDSTest.class);
...
//			System.err.println(e.getMessage());
	...
	public InputStream getResourceInputStream(String resource) throws MalformedURLException,Exception {
