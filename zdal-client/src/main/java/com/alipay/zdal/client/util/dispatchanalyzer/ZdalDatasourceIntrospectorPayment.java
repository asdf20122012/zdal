...
import com.alipay.zdal.client.jdbc.ZdalDataSourcePayment;
 ...
 * 
 * 主要是给paycore-payment的数据源使用，在既有全活又有failover的情况下，需要只检测权重>0的数据源是否正常.
 * @author 伯牙
 * @version $Id: ZdalDatasourceIntrospectorPayment.java, v 0.1 2013-9-3 下午03:55:07 Exp $
 */
public class ZdalDatasourceIntrospectorPayment {
     ...
     * Zdal封装的数据源 
     */
    private ZdalDataSourcePayment               targetDataSource;
    /**
    ...
    private CheckDBAvailableStatusPayment       checkDBAvailableStatus = new CheckDBAvailableStatusPayment();
     ...
     * @return  tddl封装后的数据源
     */
    public ZdalDataSourcePayment getTargetDataSource() {
     ...
     */
    public void setTargetDataSource(ZdalDataSourcePayment targetDataSource) {
