 ...
 * 2,从configPath获取配置信息: <bean id="testZdalDataSource"
 * class="com.alipay.zdal.client.jdbc.ZdalDataSource" init-method="init"
 * destroy-method="close"> <property name="appName" value="appName"/> <property
 * name="appDsName" value="appDsName"/> <property name="dbmode"
 * value="${dbmode}"/> <property name="configPath"
 * value="/home/admin/appName-run/jboss/deploy"/> </bean>
 * 
 * @author 伯牙
